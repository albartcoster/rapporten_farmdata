...
# Grafiek verloop productie {data-navmenu="Graphs" }

```{r,echo=FALSE}
p <- ggplot(data=mprdata[mprdata$date_time == maxd,],aes(x=dil,y=production,label = pedigree_id))+
...
# Table Snelzicht {data-navmenu="Tables" }
...
# Table Productie {data-navmenu="Tables"}
...
# Table Protein {data-navmenu="Tables"}
...
# Table Lactose {data-navmenu="Tables"}
...
# Table Ketose {data-navmenu="Tables"}
...
# Table Acidosis {data-navmenu="Tables"}
...
# Table SCC Hoog {data-navmenu="Tables"}
